/* This is a patched version of the original rang.hpp
 * The only difference is the addition of reset fields to the fgB and bgB enums
 * Their value is the same as in respective fg and bg enums
 * Also, the color output
 */
